...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        "     TexCoord1 = vTexCoord + offset1 * 0.000005;                                                                         \n"
      
        "     TexCoord2 = vTexCoord + offset2 * 0.000005;                                                                         \n"
       
        "     TexCoord3 = vTexCoord + offset3 * 0.000005;                                                                         \n"

        "     TexCoord4 = vTexCoord + offset4 * 0.000005;                                                                         \n"
...
"    originalPixel          =  originalPixel * NdotN2;                                                                                         \n"

"    highp float distance3  =  length(depth - depth3);                                                                         \n"
"    originalPixel          = originalPixel * NdotN3;                                                                                         \n"

"    highp float distance4  =  length(depth - depth4);                                                                         \n"
"    originalPixel          =  originalPixel * NdotN4;                                                                                         \n"


"    originalPixel         +=    (distance1 + distance2 + distance3 + distance4)/4.0 * 10.0 ;                                                                                         \n"

"    originalPixel         *=    originalPixel;                                                                                         \n"
